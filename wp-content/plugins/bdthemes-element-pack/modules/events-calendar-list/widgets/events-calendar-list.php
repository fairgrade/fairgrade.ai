...
namespace ElementPack\Modules\EventsCalendarList\Widgets;
 ...
 * Class Post Slider
 */
class Events_Calendar_List extends Module_Base {
	public $_query = null;

	public function get_name() {
		return 'bdt-event-list';
	}

	public function get_title() {
		return BDTEP . __('Events Calendar List', 'bdthemes-element-pack');
	}

	public function get_icon() {
		return 'bdt-wi-events-calendar-list';
	}
	...
	public function get_keywords() {
		return ['events', 'the', 'calendar', 'list', 'grid'];
	}
	...
	public function get_style_depends() {
		if ($this->ep_is_edit_mode()) {
			...
			return ['ep-events-calendar-list', 'ep-font'];
		}
	}
